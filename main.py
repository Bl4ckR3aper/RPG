...
class Warrior:
    ...
    def smallPotion(self):
        ...
        if player.hp + 5 >= Warrior.hpmax:
            print("You healed " + str(player.hpmax - player.hp) + " hp!")
...
class Hero:
    ...
    def smallPotion(self):
        ...
        if Hero.hp + 5 >= Warrior.hpmax:
            print("You healed " + str(Hero.hpmax - Hero.hp) + " hp!")
            Hero.hp = Hero.hpmax
...
while True:
    try:
        ...
        if readyConfirmation == "1":
            print("Welcome to the world of Fantasia")
            break
...
def equipScreen():
    print("\n")
    if player.wEquip != "":
        print("Weapon: " + player.wEquip)
    else:
        print("Weapon: None")
    if player.hEquip != "":
        print("Helmet: " + player.hEquip)
    else:
        print("Helmet: None")
    if player.cEquip != "":
        print("Chestplate: " + player.cEquip)
    else:
        print("Chestplate: None")
    if player.wEquip != "":
        print("Leggings: " + player.lEquip)
    else:
        print("Leggings: None")
    if player.bEquip != "":
        print("Boots: " + player.bEquip)
    else:
        print("Boots: None")
    if str(input("Would you like to change your equipment? (Y/N): ")).upper() == "Y":
        print("Which equipment would you like to change?: ")
        print("""
1. Weapon
2. Helmet
3. Chestplate
...
def homeScreen():
    ...
    if homescreenInput == 1 and level1P == False:
        level1()
    if homescreenInput == 1 and level2P == False:
        # level2()
        print("")
    if homescreenInput == 1 and level3P == False:
        # level3()
        print("")

    if homescreenInput == 2 and level2P == False:
        print("There is no shop for you to go to!")
    else:
        shop()
...
def inlevelMenue(eChangeAllowed, bagAllowed, gototownAllowed):
    ...
    while True:
        ...
        if eChangeAllowed == True:
            ...
            numbermenue += 1
            print(str(echange) + ". Change Equipment")
        if bagAllowed == True:
            bchange = numbermenue + 1
            numbermenue += 1
            print(str(bchange) + ". Use bag items")
        if gototownAllowed == True:
            tchange = numbermenue + 1
            numbermenue += 1
            print(str(tchange) + ". Go Back to Town")
        if True:
            cCHange = numbermenue + 1
            numbermenue += 1
            print(str(cCHange) + ". Exit Menue")
...
def enemyDamage():
    ...
    if missChancE == 1:
        print("The enemy missed the attack and did no damage to you!")
    else:
        if Hero.magicAllowed == True:
            if magic == 3 and enemy.mp >= 2:
                ...
                enemy.fireball()
                print("The enemy cast fireball on you!")
                enemy.mp -= 2
        else:
            critE = random.randrange(1, enemy.critChance)
            if critE == 1:
                player.hp -= (enemy.attack * 2)
                print("Critical Hit! The enemy did " + str(enemy.attack * 2) + " damage to you!")
            else:
                player.hp -= enemy.attack
                print("The enemy damaged you by " + str(enemy.attack) + " hp!")
    if player.poisoned == True:
        player.hp -= round(0.07 * (player.hpmax))
        print("You lost " + (str(round(0.07 * (player.hpmax)))) + " points from the poison!")
    if enemy.poisoned == True:
        enemy.health -= round(0.07 * (enemy.hpmax))
        print("The enemy lost " + str(round(0.07 * (enemy.hpmax))) + " points from poison!")
    if player.status == "Burning":
        player.hp -= round(0.09 * (player.hpmax))
        print("You lost " + str(round(0.09 * (player.hpmax))) + " points from burning!")
    if Hero.poisoned == True:
        Hero.hp -= round(0.07 * (Hero.hpmax))
        print("You lost " + (str(round(0.07 * (Hero.hpmax)))) + " points from the poison!")
    if Hero.status == "Burning":
        Hero.hp -= round(0.09 * (Hero.hpmax))
        print("You lost " + str(round(0.09 * (Hero.hpmax))) + " points from burning!")
 ...
 `------'  `------'     `-'      `------'`------'        `---' 
    ...
    def battle1(fighter, dropNames, asd, bsd, csd, mainPlayer):
        while fighter.hp > 0 and enemy.health > 0:
            print("\n")
            print(fighter.name + "'s HP: " + str(fighter.hp))
            print(enemy.name + "'s HP: " + str(enemy.health))
            print("MP: " + str(fighter.magic) + "\n")
            print("""What would you like to do?
                    1. Attack
                    2. Defend
                    3. Item
            ...
            if battleD == 1:
                ...
                if missChancP == 1:
                    ...
                    if crit == 1:
                        ...
                        print("Critical Hit! You did " + str(fighter.attack * 1.5) + " damage on the enemy")
                        enemyDamage()
                        continue
                    else:
                        enemy.health -= fighter.attack
                        print("You did " + str(player.attack) + " damage on the enemy!")
                        enemyDamage()
                        continue
            ...
            if battleD == 2:
                ...
                if defenceT > enemy.attack:
                    ...
                    print("You were unable to defend the attack!")
                    enemyDamage()
                    continue

            if battleD == 3:
                for i in range(0, len(fighter.bag)):
                    print(str(i + 1) + "." + fighter.bag[i])
                while True:
                    try:
                        bagInput = int(input("What item would you like to use?: "))
                    except ValueError:
        ...
        if mainPlayer == True:
            ...
            time.sleep(0.5)
            print(enemy.name + "dropped " + dropNames)
            global pickup1
            ...
            if player.exp >= round((4 * (player.level ** 3)) / 5):
                ...
                print("You have reached level " + str(player.level) + "!")
                time.sleep(1)
                temphp = player.hpmax
                ...
                print(str(temphp) + " hp --> " + str(player.hpmax) + " hp")
                time.sleep(1)
                print(str(tempAttck) + " Attack --> " + str(player.battack) + " Attack")
                time.sleep(1)
                print(str(tempdef) + " defense --> " + str(player.bdefense) + " defense")
                time.sleep(1)
                print(str(tempagil) + " Agility --> " + str(player.agilityMax) + " Agility")
                time.sleep(1)
    ...
    while True:
        pathChoice = int(input("""Which path would you like to take?
        ...
        if str(pathChoice) == "1":
            ...
            if player.bEquip != "":
                player.rockyLand(False)
                print("The land was no longer hard to traverse!")
                typingEffect(
     ...
     ` ``""")
            ...
            def battleHero():
                while hero.hp > 0 and enemy.health > 0:
                    print("\n")
                    print(hero.name + "'s HP: " + str(hero.hp))
                    print(enemy.name + "'s HP: " + str(enemy.health))
                    print("MP: " + str(hero.magic) + "\n")
                    print("""What would you like to do?
                            1. Attack
                            2. Defend
                            3. Item
                    ...
                    if battleD == 1:
                        ...
                        if missChancP == 1:
                            ...
                            if crit == 1:
                                ...
                                print("Critical Hit! You did " + str(round(hero.attack * 1.5)) + " damage on the enemy")
                                battleknight()
                                continue
                            else:
                                enemy.health -= hero.attack
                                print("You did " + str(hero.attack) + " damage on the enemy!")
                                battleknight()
                                continue
            ...
            def battleknight():
                ...
                if enemy.status == "Burning":
                    Hero.hp -= round(0.09 * (Hero.hpmax))
                    print("The enemy lost " + str(round(0.09 * (enemy.hpmax))) + " points from burning!")
                if enemy.status == "Hazed":
                    enemy.attack = 0.9 * (enemy.attack)
            ...
            typingEffect("You wake up back to where you were standing and wonder what just happened. Were you dreaming?\n")
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@""")
        ...
        if str(pathChoice) == "2":
            ...
            player.AgilityBuff(True)
            print("The first Giant goblin in your way spots you!")
            enemy = GiantGoblin(" Giant Goblin #1", False, [], [], ["Rusty Helmet"], [], [], [], 50)
            battle1(" Rusty Helmet and 50 gold", True, True, False)
            ...
            if str(input("Would you like to take an alternate path?: (Y/N) \n")).upper() == "Y":
                ...
                battle1("Nothing", True, True, False)
...
def itemPickup():
    if len(player.bag) < 20:
        ...
        for i in range(0, len(enemy.weapons)):
            player.weapons.append(enemy.weapons[i])
        for i in range(0, len(enemy.headArmour)):
            player.headArmour.append(player.headArmour[i])
        for i in range(0, len(enemy.chestArmour)):
            player.chestArmour.append(player.chestArmour[i])
        for i in range(0, len(enemy.legArmour)):
            player.legArmour.append(enemy.legArmour[i])
        for i in range(0, len(enemy.boots)):
            player.boots.append(enemy.boots[i])
